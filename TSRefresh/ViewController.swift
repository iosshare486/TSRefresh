...
class ViewController:UIViewController{
    ...
    override func viewDidLoad() {
        ...
        self.scrollView?.ts_pullDownToRefreshText("亲，试试下拉会刷新的")
            ...
            .ts_refreshingText("亲，正在努力刷新").ts_footerTextColor(.yellow).ts_pullUpToRefreshText("哈哈哈").ts_pullDownToRefreshText("啦啦啦").ts_noMoreDataText("nnnnn").ts_releaseLoadMoreText("撒手试试")
        // color
